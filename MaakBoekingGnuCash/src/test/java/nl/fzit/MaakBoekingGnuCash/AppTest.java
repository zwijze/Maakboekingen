...
//            FileInputStream in = new FileInputStream("src\\main\\config\\config.xml");
            ...
            if (System.getProperty("os.name").startsWith("Windows")) {
            	in = new FileInputStream("C:\\mijn documenten\\Maakboekingen\\maakboekingen\\plugins\\config\\configGnuCash.xml");
            }else {
            	in = new FileInputStream("/home/frank/git/Maakboekingen/maakboekingen/plugins/config/configGnuCash.xml");
            }
